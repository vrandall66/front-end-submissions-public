...
- Bc of that for-in loop I've got to keep you at a two, in reality, the code looks more in the 3 range otherwise though.
...
- Adjust your text-based UI to look more balanced on the desktop view
