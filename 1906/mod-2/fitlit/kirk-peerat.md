...
* Make use of those beforeEach hooks to DRY up your setup code, split multiple expectations for different input/outputs into multiple it blocks and wrap them in a describe block
...
* Good job on consistency and determining the path that made most sense to you 
...
* Hover effect for drag and drop doesn't quite give me enough information for how I should be interacting with those elements - cursor: grab
