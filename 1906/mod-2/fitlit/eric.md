...
* Very nice job working solo and getting through it, it's a lot of code that needs to be written for this project and you didn't fall behind at all without a partner! Working solo is an extension on its own in my opinion :)
...
* Some opportunities for refactoring/DRYing up your code but overall it is very clean and readable, most methods are kept super small and following SRP. Great job!
...
* Very good test coverage - only recommendation was the refactoring for moving related it blocks for the same method into a nested describe block.
...
* Very nice commit messages but you need wayyyyyyyy more commits. The amount of work that needs to be done in this project should take *at least* 100 commits.  You made 27. This is a sign that your commits are doing way too much. Try to find an earlier stopping point in your work where it could make sense to do a commit. Getting the feel for this is hard, but just recognize and keep in mind that you're currently erring on the side of bigger commits and we want much smaller! 