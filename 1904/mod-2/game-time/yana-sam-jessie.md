...
* Functionality completion unclear as I was only able to play through a single round in the UI
...
* Not entirely sold on the crosshair cursor...it's not indicating to me what I can/can't click on. Whenever I can click on an element, I should see that pointer cursor to let me know it's something I can interact with.

* Was able to run through a single round -- don't believe I encountered a daily double, and doesn't appear like I can move onto a further round from here. (Or restart a new game without refreshing the page)
...
* Good variable naming conventions, they are specific enough to know what they are but generic enough that they won't need to change as the design changes.

* Would like to see you get some practice with nesting by implementing some hover/active states on your clickable elements
...
* Methods are nice and tiny and easy-to-read, but it seems like we're lacking quite a bit of functionality that makes it difficult to give much more feedback
...
* [This](https://github.com/yaleksandrova/GameTimeJeopardy/blob/master/test/Clues-test.js#L31-L33) is quite a bit of execution phase, you'd ideally like to be able to test each of these methods independent of each other. Having to do all this execution to write an assertion is likely a sign that your methods are too coupled

* Missing a lottttt of method tests for your classes, and I'm not seeing any use of spies which may have been a painpoint for writing your method tests?
