...
The pop-up card makes the page very busy with all of the text and images behind the popups.
There is a separation of beaches and maps. When I'm going to find a beach, I want to see the beach and where it is simultaneously. Right now, I have to go back and forth between the Beaches and Maps pages.
