...
### Students: Whitney and Justin
### Comments:

* Don't add things unless you use them
* Work on naming conventions - think about the user's perspective
* Think about SRP and pulling things out into other functions
