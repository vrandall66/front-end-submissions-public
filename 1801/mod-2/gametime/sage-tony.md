# Game Time
* Students: Sage Vogt, Tony Robertson
* Evaluator: Leta, Cody

Comments:
* tests look good, figured out how to isolate hard to test dependencies (dom, audio)
* code well organized
* no inheritance, but understanding of how it would be done
* git workflow looks pretty good
