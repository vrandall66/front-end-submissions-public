...
### Students: Jessica and Niraj
### Comments:

* Keep one source of truth for data on the frontend. reference elsewhere (ie. utilize movieid).
* Implement thunks to clean up components
