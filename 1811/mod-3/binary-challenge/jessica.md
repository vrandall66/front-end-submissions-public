...
* Take the amount of time you think something will take, and multiply it by 2
* Always better to undersell and overdeliver
* One source of truth. Pick state or props. 
* Consider using helpers
