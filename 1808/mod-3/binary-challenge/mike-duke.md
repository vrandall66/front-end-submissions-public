...
Trying to come up with a plan ( gh issues, waffle ) split it up into user stories ( can they share the same code)
Look for opportunities to separate concerns or add helpers 
developer empathy is lacking in some places
