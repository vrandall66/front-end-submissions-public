# Game Time
* Students: Lee & Megan H
* Evaluator: Leta

Comments:
* Index file is nice and clean - good separation of responsibility
...
fail - 2
- Game file is not tested
- Class files do not test properties being updated
