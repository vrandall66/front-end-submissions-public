...
* Can't answer final round question
* Some answered questions can be clicked on again even after answered
...
* The theme is great. I wish it tied to the questions, but that would be a great next step.
...
* Currently lacks a lot of testing, but what tests do exist are a good start, but many of them are failing
* Improvements to testing were made to the testing suite. It is still not what would be expected out of a successful testing suite, but good to see some more work put into it.
