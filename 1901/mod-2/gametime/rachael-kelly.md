# GameTime
* Students: Rachael & Kelly
* Evaluator: Pamela Lovett

Given 24 hour extension to improve in 2 of the 3 categories: functional expectations, testing, and OOP.

- Great improvements in functionality! Playable through four rounds (no final round) with a few bugs (scores not incrementing correctly; can pick a letter without spinning; tiles reveal answer with cursor of mouse)
- OOP: Still quite a bit of coupling throughout classes
- Testing: Added some basic tests - some of which are testing methods that do not exist. Many tests do not check for state updates or output from methods - instead, checking that something is a function or has been called.
