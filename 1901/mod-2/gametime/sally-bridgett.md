# GameTime
* Students: Sally & Bridgett
* Evaluator: Pam

Given 24 hour extension to improve in 2 of the 3 categories: functional expectations, testing, and OOP.

- Great improvements in functionality! Still some bugs (no final round - puzzles change but game continues past 4 rounds; can guess letters without new wheel spin; tiles reveal answer with cursor of mouse)
- OOP: Still some misplaced logic for OOP principles - but good improvement from where it was at eval time - especially in `Puzzle` class
- Testing: No updates to testing.
