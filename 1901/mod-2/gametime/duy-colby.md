...
* No bonus round (5th round) - all other rounds work
...
* Testing was ok, but more method tests should be done, even though some were about random number generation.
...
* Overall clean OOP, but some refactoring to do. Passing.
