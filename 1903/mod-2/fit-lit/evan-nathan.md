...
* I didn't see an extension, but the progress was great.
...
* Great job utilizing small test data
...
* Great implementation of `chart.js` - the UI gave a lot of information and still didn't look too busy, which can be a tough balance.
