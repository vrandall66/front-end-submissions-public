...
- Good job with articulation, staying engaged, and body language, overall.
- The animation on the slides were sometimes too much of a distraction. Be careful with adding too many animations.
- I appreciate the build up to showing/demoing the game; however, I would suggest making that intro a _tad_ bit earlier. Your audience definitely needs background/context for the project - but there's the potential that you will lose their interest if you delay showing the app for too long.