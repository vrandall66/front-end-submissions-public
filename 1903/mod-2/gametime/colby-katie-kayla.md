...
- Love the background/context that you watched an episode to make sure that you really understood the problem you were solving (how to create an app like the gameshow)
- Really good posture, overall. 
- Nice, clear projection of what you’re saying